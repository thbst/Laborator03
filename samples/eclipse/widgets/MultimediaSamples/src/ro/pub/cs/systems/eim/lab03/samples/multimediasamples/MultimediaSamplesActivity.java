 package ro.pub.cs.systems.eim.lab03.samples.multimediasamples;
...
import ro.pub.cs.systems.eim.lab03.samples.multimediasamples.R;
...
public class MultimediaSamplesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		androidHistoryVideoView.setVideoURI(Uri.parse("http://eim2016.andreirosucojocaru.ro/TheShortHistoryOfAndroid480p.mp4"));
